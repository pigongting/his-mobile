...
class OutpatientPayList extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const row = (rowData, sectionID, rowID) => {
      console.log(rowData);
      return (
        <Link key={rowID} className={styles.recordItem} to={`/${this.props.locale}/outpatientpay/detail?status=${status}&id=${rowData.orderId}`}>
          <List>
...
export default connect(mapStateToProps, mapDispatchToProps)(OutpatientPayList);
